...
Note
   ...
   balancin algorithm should the driver use: (1) "random" - the
   ...
   be able to determine the optimium number of parameters per
   ...
   driver? true 5.0.6
   useFastDateParsing Use internal String->Date/Time/Teimstamp
   ...
   are CONCUR_UPDATABLE, should the driver pre-poulate the
   ...
   implement "" that should be placed "in between" query
   execution to influence the results. StatementInterceptors are
   "chainable", the results returned by the "current"
   interceptor will be passed on to the next in in the chain,
   from left-to-right order, as specified in this property.
   5.1.1
...
1.5.1.3. Using CallableStatements to Execute Stored Procedures
   ...
   See Stored Procedures and Functions
   (http://dev.mysql.com/doc/refman/5.0/en/stored-procedures.htm
   l), for more information on MySQL stored procedures.
